...
public class MainActivityTest {
    ...
    public void checkFirstImageIsCorrect() {
        ...
        onView(withId(R.id.first_image)).check(matches(withDrawable(R.drawable.left_beta)));
        onView(withId(R.id.first_image)).check(matches(hasDrawable()));
    }

    @Test
    public void checkSecondImageIsCorrect() {
        // Type text and then press the button.
